...
function fetchRandomCocktail() {
	fetch(cocktaildbUrl)
		...
		.then((data) => {
			...
			drinkFront
				.empty()
				.append($drinkPicture, $drinkName, $drinkIngredients);
...
//Event Listeners
// Add click listener for find recipe button
...
// Add click listener for random recipe button
